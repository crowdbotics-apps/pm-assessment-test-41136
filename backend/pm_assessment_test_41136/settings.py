"""
Django settings for pm_assessment_test_41136 project.
...
ROOT_URLCONF = 'pm_assessment_test_41136.urls'
...
WSGI_APPLICATION = 'pm_assessment_test_41136.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pm_assessment_test_41136 API",
    "DESCRIPTION": "API documentation for pm_assessment_test_41136 App",
    "VERSION": "v1",
}
